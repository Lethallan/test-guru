...
User.create!(
  [
    ...
    { first_name: 'Smeagol', last_name: 'Gollum', email: 'gollum_gollum@bla.com', password: 'mypresciois' },
  ]
)
...
Test.create!(
  [
    ...
    { title: 'Silmarils', level: 3, category_id: 3, user_id: User.find_by(email: 'melkor_the_best').id }
  ]
)
